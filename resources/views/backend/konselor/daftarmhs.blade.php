                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <button type="button" class="btn btn-success" style="margin-left:900px;"><a href="{{url('tambahmahasiswa')}}">Tambah</a></button>
                                </div>
                                        ...
                                        <table class="table table-striped table-bordered patients-list datatable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $mhs->nim }}</td>
                                                    <td>{{ $mhs->nama }}</td>
                                                    <td><a href="{{url('mahasiswa/'.$mhs->nim.'/edit') }}"><i class="ft-edit text-success"></i></a>
